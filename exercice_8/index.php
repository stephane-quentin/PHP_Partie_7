...
<html lang="fr" dir="ltr">
  ...
  <body>
    <?php
    if(empty($_POST['lastname']) || empty($_POST['firstname']) || (pathinfo($_FILES['myFile']['name'],PATHINFO_EXTENSION) != 'pdf'))
    {
      ?>
    <div class="jumbotron">
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <p><label class="font-weight-bold">Fichier (uniquement .pdf) : </label>
